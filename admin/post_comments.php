    ...
    if(isset($_GET['id'])){
        $comment_id = $_GET['id'];
            ...
            if(isset($_GET['unapprove'])){
               ...
               header("Location:comments.php");                //basically this function refresh the page.
            }
            ...
            if(isset($_GET['delete'])){
                ...
                header("Location:post_comments.php?id=" . $_GET['id'] . "");                //basically this function refresh the page.
            }
        }?>
